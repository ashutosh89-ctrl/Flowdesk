...
export function FreelancerSettingsClient() {
  ...
  return (
    <div className="flex-1 flex flex-col font-sans h-full bg-[#F5F5F3] overflow-hidden select-none relative">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-56 border-r border-black/5 bg-white/20 p-4 space-y-1 shrink-0">
          {navTabs.map((tab) => {
            const Icon = tab.icon;
